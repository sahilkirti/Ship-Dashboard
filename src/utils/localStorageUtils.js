...
export const initMockData = () => {
  if (!localStorage.getItem("users")) {
    const mockData = {
      ...
      ships: [
        { id: "s1", name: "ESsver Given", imo: "9811000", flag: "Panama", status: "Active" },
    ...
    for (const key in mockData) {
      setData(key, mockData[key]);
    }
  }
};

export const getUsers = () => getData("users");
export const getShips = () => getData("ships");
export const getComponents = () => getData("components");
